    ...
    <div id="background-image"></div>
        ...
        <div id="global-side-bar">
            ...
            <nav class="nav-menu">
                ...
                <a href="app/playlists.php" class="nav-menu-item">
                <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 960"  width="30" height="30">
                    <style>
                        .s0 { fill: #ffffff }
                    </style>
                ...
                <a href="app/downloader.php" class="nav-menu-item">
                <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 960" width="30" height="30">
                    <style>
                        .s0 { fill: #ffffff }
                    </style>
                ...
                <a href="app/tag-editor.php" class="nav-menu-item">
                <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 960" width="30" height="30">
                    <style>
                        .s0 { fill: #ffffff } 
                    </style>
                ...
                <span>&nbsp&nbspMusic Editor&nbsp&nbsp</span></a>
            </nav>
